    ...
    stages{
        ...
        stage('Deploy') {
            steps {
                ...
                sh 'ssh -i "/home/jenkins2/id_rsa" ubuntu@ec2-13-58-91-243.us-east-2.compute.amazonaws.com ; ssh -t "/home/jenkins2/id_rsa" ubuntu@ec2-13-58-91-243.us-east-2.compute.amazonaws.com 'nohup ./main &; bash -1' '
            }
        }
    }
}